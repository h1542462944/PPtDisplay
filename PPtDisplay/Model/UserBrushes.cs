...
namespace PPtDisplay.Model
{
    ...
    public static class UserBrushes
    {
        ...
        /// 80%alpha黑色(0,0,0)
        /// </summary>
        public static Brush DeepBlack => new SolidColorBrush(Color.FromArgb(204, 0, 0, 0));
        public static Brush StrongBlack => new SolidColorBrush(Color.FromArgb(153, 0, 0, 0));
    }
}
